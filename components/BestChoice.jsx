...
const BestChoiceContainer = () => {
  ...
  return (
    <div className="lg:w-full lg:mx-auto lg:bg-[#F2FFF0] lg:text-black lg:m-5 lg:pt-16 lg:pb-16 lg:leading-0 sm:w-full sm:bg-[#F2FFF0] sm:m-0 sm:pt-10 sm:pb-5 text-black w-full bg-[#F2FFF0] m-1 pt-12 pb-5  ">
      <h3
        className="lg:mx-32 lg:my-5 lg:w-1/2 lg:text-3xl lg:font-inter lg:leading-0 lg:font-bold sm:mx-3 sm:text-4xl sm:font-inter sm:leading-normal sm:font-bold sm:w-3/4 sm:mb-0 sm:ml-16 mx-3 text-xl font-inter leading-normal font-bold w-2/3 mb-2 ml-8"
        style={{ color: "#000000" }}
      >
        What makes us the best choice for a career in Pharma?
      </h3>

      <div className="lg:grid-cols-4 lg:grid lg:gap-2 lg:mx-32 sm:flex sm:gap-1 sm:flex-col sm:mx-8 flex gap-2 flex-col :mx-8">
        {/* First row */}
