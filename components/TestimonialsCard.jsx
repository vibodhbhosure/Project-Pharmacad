...
const TestimonialsCard = ({ cardData }) => {
    ...
    return (
        <div className="bg-white border border-gray-300 border-opacity-60 shadow-md rounded-lg h-max-45 text-black flex flex-row m-2 pb-2 ">
            <div className="flex flex-row items-center">
                ...
                <div className="flex flex-col">
                    ...
                    <div className="flex flex-col w-full items-end lg:flex lg:flex-col lg:w-full lg:items-end ">
                        <div className="px-6 font-montserrat font-thin lg:px-6 lg:font-montserrat lg:font-thin">{testimonial}</div>
                        <div className="px-6 font-semibold pt-2">── {name}</div>
                        <div className="px-6 font-poppins font-thin text-xs  lg:px-6 lg:font-poppins lg:font-bold lg:text-sm">{rank}</div>
                    </div>
