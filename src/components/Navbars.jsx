    ...
    <header className="mb-24">
      <nav className={`nav flex sticky bg-white top-0 shadow-2xl h-min`}>
        ...
        <div className="mt-3 mb-10 justify-start z-20 w-40 md:mt-10 mb:10 md:justify-start md:ml-4 md:z-40 md:h-5 md:w-20 md:top-3 lg:mt-10 lg:justify-start lg:fixed lg:ml-4 lg:z-20 lg:h-40 lg:w-40 lg:top-3 xl:mt-10 xl:justify-start xl:ml-24 xl:z-20 xl:h-40 xl:w-40 xl:fixed xl:top-3">
          <Image
            className="z-30 absolute ml-6 md:absolute md:z-40 md:ml-6 md:mt-8 lg:absolute lg:z-40 lg:ml-6 lg:mt-8 xl:z-40 xl:ml-6 xl:mt-8"
            src={svg1}
            width={80}
            height={80}
            alt="logo"
        ...
        <div className="top-3 bg-white md:mt-14 lg:fixed lg:left-0 lg:bg-white lg:w-full lg:z-10 lg:mt-10 xl:bg-white xl:fixed xl:left-0 xl:w-full xl:z-10">
          <div className="hidden lg:flex lg:px-2 lg:bg-white lg:text-black lg:justify-end lg:mr-1 lg:shadow-2xl xl:w-full xl:flex xl:px-4 xl:p-2 xl:text-black xl:justify-end xl:shadow-2xl xl:bg-white">
            <div
              className={`${
                navActive ? "active" : ""
              } lg:flex lg:p-2 xl:ml-10 xl:flex xl:mr-16`}
            >
