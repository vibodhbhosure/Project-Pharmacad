...
const Card = ({ cardData }) => {
  ...
  return (
    <div
      className="xl:h-[16rem] lg:w-241 lg:bg-white lg:rounded lg:p-0.5 lg:pb-1 lg:m-1 lg:max-h-full lg:h-[25rem] sm:m-6 sm:bg-white sm:max-h-full sm:rounded-xl  bg-white rounded-lg max-h-full pb-1  mx-8"
      style={{
        background: "#ffffff",
    ...
    >
      <div className="lg:flex-col ">
        <div className="lg:pt-1 lg:pl-1">
          <Image
            className="lg:mx-5 lg:mt-4 lg:w-16 lg:pt-0 sm:mt-4 sm:pt-10 sm:ml-6 sm:w-28 mt-4 pt-4 ml-6 w-16"
            src={svg}
            alt={title}
          />
        </div>
        <div
          className="lg:px-4 lg:my-0 lg:py-2 lg:w-30 lg:text-base lg:font-semibold lg:font-inter lg:mx-1 sm:px-4 sm:py-2 sm:w-30 sm:my-2 sm:text-3xl sm:font-bold sm:font-inter sm:mx-3 px-4 py-2 w-30 my-0.5 text-base font-bold font-inter mx-3"
          style={{ color: "#000000" }}
        >
          {title}
        </div>
