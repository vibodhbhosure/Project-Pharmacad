...
const Contact = () => {
  ...
  return (
    ...
    >
      ...
      <div className="mb-4">
        <label htmlFor="mobile" className="block text-gray-900 font-medium mb-1">
      ...
      <div className="mb-4">
        <label htmlFor="college" className="block text-gray-900 font-medium mb-1">
      ...
      <div className="mb-4">
        <label htmlFor="course" className="block text-gray-900 font-medium mb-1">
        ...
        >
          ...
          <option value="course4">Pharmacovigilance Certificate Course</option>
          <option value="course5">Intellectual Patent Rights Certificate Course</option>
