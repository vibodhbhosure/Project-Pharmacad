...
const Contact = () => {
    return (
        <div className="container mx-auto max-w-screen-xl px-4 py-8">
            <h1 className="text-4xl text-left font-bold mb-2 font-inter">Contact Us</h1>
            <p className="text-xl text-left font-normal mb-6 font-inter">- Reach out to us and start your path to success</p>
            <div className="max-w-7xl w-full pl-8 rounded shadow-lg ">
                <div className="flex flex-col md:flex-row md:space-x-8">
                    ...
                    <div className="flex-1 mt-4 md:mx-6 mr-6">
                        ...
                        <div className="mb-4">
                            <label htmlFor="name" className="block text-gray-900 font-medium mb-1">Name<span className="text-red-500">*</span></label>
                            <input type="text" id="name" className="w-full border-gray-300 border rounded px-3 py-2" required />
                        </div>
                        <div className="mb-4">
                            <label htmlFor="email" className="block text-gray-900 font-medium mb-1">Email<span className="text-red-500">*</span></label>
                            <input type="email" id="email" className="w-full border-gray-300 border rounded px-3 py-2" required />
                        </div>
                        <div className="mb-4">
                            <label htmlFor="mobile" className="block text-gray-900 font-medium mb-1">Mobile<span className="text-red-500">*</span></label>
                            <input type="tel" id="mobile" className="w-full border-gray-300 border rounded px-3 py-2" required />
                        </div>
                        <div className="mb-4">
                            <label htmlFor="college" className="block text-gray-900 font-medium mb-1">College Name<span className="text-red-500">*</span></label>
                            <input type="text" id="college" className="w-full border-gray-300 border rounded px-3 py-2" required />
                        </div>
                        <div className="mb-4">
                            <label htmlFor="course" className="block text-gray-900 font-medium mb-1">Course Selected<span className="text-red-500">*</span></label>
                        ...
                        <div className="mb-4">
                            <label htmlFor="message" className="block text-gray-900 font-medium mb-1">Message</label>
                            <textarea id="message" rows={5} className="w-full border-gray-300 border rounded px-3 py-2"></textarea>
                        </div>
              ...
              <span className="font-inter">pharmacad.india@gmail.com</span>
            </div></li></ul>
              ...
              <span className="font-inter">Shishu Vihar Mandal, High School, opp. King George, near Ruia College, Matunga Central Railway Workshop, Dadar East, Dadar, Mumbai, Maharashtra-400014</span>
            </div></li></ul>
              ...
              </span> <p className="font-inter">G.E.I.S,M.H. High school and Junior College,
