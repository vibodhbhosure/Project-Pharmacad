...
const CoursesOffered = () => {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-8 pb-2">
        {courses.map((course, index) => (
          <div key={index} className="bg-white p-4 rounded-4xl shadow-md">
            <h3 className="text-sm font-light font-inter ">{course.headiing}</h3>
            <h3 className="text-2xl font-bold font-inter mb-2">{course.name}</h3>
            <p className="mt-2 text-gray-700 font-light font-montserrat mb-2">{course.description}</p>
            <a href="#" className="text-black font-semibold font-raleway mt-4 inline-block">Learn More</a>
          </div>
        ))}
      </div>
  ...
  <div className="justify-left md:flex md:justify-left">
    ...
    <p className="text-semibold mb-2 md:mb-0 font-raleway">To book a free demo , <a href="#" className="text-black font-raleway font-bold underline">
      Click here!
    </a></p>
