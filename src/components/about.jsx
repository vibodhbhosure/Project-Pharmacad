            ...
            <div className="flex flex-col lg:flex-row justify-between gap-10">
                <div className="w-full lg:w-5/12 flex flex-col justify-center">
                    ...
                    <p className="font-normal text-base leading-6 text-gray-600 mt-11">
                        Pharmacad also provides Industrial training, career counseling, B. Pharmacy &
                        D. Pharmacy coaching, industrial affiliated certificate courses like Pharmacovigilance, Intellectual Property Rights, Regulatory Affairs, Clinical Research Management etc.
                    </p>
                </div>
                <div className="hidden md:block">
                    <div className="w-full lg:w-8/12">
                        <img className="w-auto h-auto" src="/Rectangle 364.svg" alt="SVG image" />
                        <img className="w-auto h-auto my-5 " src="/Rectangle 323.svg" alt="SVG image" />
                    </div>
                </div>
            </div>
