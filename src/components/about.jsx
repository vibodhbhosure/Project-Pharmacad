        ...
        <div className="container mx-auto max-w-screen-xl px-4 py-8">
            <div className="flex flex-col lg:flex-row justify-between gap-10">
                <div className="w-full lg:w-8/12 flex flex-col justify-center">
                    <h1 className="text-4xl lg:text-4xl font-bold font-inter leading-9 text-gray-800 pb-4">About Us</h1>
                    <p className="font-lg text-lg leading-6 font-montserrat text-gray-600 ">India’s Best Coaching Class for M. Pharmacy, MBA entrance exams & Abroad Studies for Pharmacy students. Experts in GPAT, NIPER, BITS, Manipal, ICT & other entrance exams, also MBA entrance  (CAT / NMAT / CET / SNAP / XAT / CMAT, etc.) exams. More than 30 tutors & content creators from India’s top ranked institutes like NIPER, BITS, ICT, BCP, Punjab University etc., working together to provide you the best & quality education via offline & online platform.
                    </p>
                    <p className="text-lg leading-6 text-gray-600 mt-8">We offer</p>
                    <ul className="list-disc list-inside">
                        <li className="font-semibold text-lg font-montserrat leading-6 text-gray-600 ">15,000+ plus MCQs with explanations</li>
                        <li className="font-semibold text-lg font-montserrat leading-6 text-gray-600 ">More than 700+ videos</li>
                        <li className="font-semibold text-lg font-montserrat leading-6 text-gray-600 ">Detailed & conscised notes & synopsis</li>
                        <li className="font-semibold text-lg font-montserrat leading-6 text-gray-600 ">E-books</li>
                    </ul>
