...
const CourseCard = ({ cardData }) => {
    ...
    return (
        ...
        <div className='flex flex-row mt-10 ml-10 pt-7'>
            ...
            <span className=' box-border uppercase bg-[#F5752D] text-white m-auto p-1 ml-[72px] font-semibold text-xs rounded-sm '>{mode}</span>
            <span className='uppercase m-auto p-1 px-2 font-medium text-xs bg-[#E8F0FC] ml-[10px] rounded-sm'>{status}</span>
        </div>
