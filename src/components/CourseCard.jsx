    ...
    <div className=" mt-7 h-full w-[310px] md:w-[572px] mx-auto md:mx-0 shadow-[0_3px_10px_rgb(0,0,0,0.2)] rounded-md border-[#E5E5E5]">
      <div className="flex flex-col md:flex-row mt-10 ml-10 pt-7">
        ...
        <div className="flex flex-row">
          <span
            ...
            } text-white m-auto p-1 ml-[0px] md:ml-[72px] mt-3 md:mt-[0px] font-semibold text-xs rounded-sm`}
          >
            {mode}
          </span>
          <span
            ...
            } uppercase m-auto p-1 px-2 font-medium text-xs bg-[#E8F0FC] ml-0.5 md:ml-[50px] mt-3 md:mt-[0px] rounded-sm`}
          >
            {status}
          </span>
        </div>
      ...
      <div className=" w-[272px] md:w-[490px] bg-[#F5F5F5] mt-5 mx-auto md:ml-10">
        <ul className="list-disc ml-5 p-5">
          {desc.map((item, index) => (
            <li
              key={index}
              className="font-semibold font-montserrat text-xs mt-[6px]"
            >
              {item}
            </li>
          ))}
      ...
      <div className="ml-5 md:ml-10 mt-7">
        ...
        <button
          className={`${
            price === null ? "hidden" : ""
          } box-border bg-[#3A47FB] text-[white] shadow-xl m-auto p-3 font-semibold text-sm rounded-lg ml-12 mt-3 md:mt-[0px]`}
        >
