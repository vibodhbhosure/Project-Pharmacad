  ...
  return (
    <div className="w-full border-2 border-white mb-[109px]">
      ...
      <div className=" mt-[440px] sm:mt-48 md:mt-[220px] mx-6 lg:ml-[131px] xl:pl-20">
        ...
        <div className="border-2 border-[#DBDBDB] w-[310px] sm:w-[500px] md:w-[700px] lg:w-[875px] xl:w-[1050px] h-[271px] mt-7 shadow-[0_3px_10px_rgb(0,0,0,0.2)] mx-auto lg:mx-0">
        ...
        <div className="grid-cols-1 grid lg:grid-cols-2 grid-flow-row gap-y-9 gap-x-0 ">
          {courseDataArray.slice(0, 4).map((cardData) => (
            <div key={cardData.id} className="lg:w-fit ">
